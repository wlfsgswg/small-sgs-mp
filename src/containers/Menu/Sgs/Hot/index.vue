        ...
        <div class="bottom">
          <div class="view">
            <img
              ...
              alt=""
              class="icon"
            /><span class="likeText">{{ item.view_count }}</span>
            <img
              ...
              alt=""
              class="icon"
            /><span class="likeText">{{ item.reply_count }}</span>
            <div style="align-items: center; display: flex">
              <img
                ...
                alt=""
                class="icon"
              /><span class="likeText">{{ item.like_count }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      this.$API[keyword ? "searchSgslist" : "getSgslist"](data)
        .then((res) => {
          ...
          this.list = Array.from(
            new Map(
              [...this.list, ...readNumMaxData].map((item) => [item.id, item]),
            ).values(),
          );
